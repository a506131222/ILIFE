...
@class ZJMQRCodeAlbumManager;

@protocol ZJMRCodeAlbumManagerDelegate <NSObject>
...
- (void)QRCodeAlbumManager:(ZJMQRCodeAlbumManager *)albumManager didFinishPickingMediaWithResult:(NSString *)result;

@end

@interface ZJMQRCodeAlbumManager : NSObject
/** 快速创建单利方法 */
+ (instancetype)sharedManager;
/** SGQRCodeAlbumManagerDelegate */
@property (nonatomic, weak) id<ZJMRCodeAlbumManagerDelegate> delegate;
/** 判断相册访问权限是否授权 */
