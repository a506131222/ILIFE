...
#import "ZJMBaseVC.h"
typedef void(^BackLineCode)(NSString *lineCode);
@interface RHScanViewController : ZJMBaseVC<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
@property (nonatomic,copy)BackLineCode backLineCode;
#pragma mark - 扫码界面操作等
