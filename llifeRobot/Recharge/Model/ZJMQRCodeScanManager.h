...
@class ZJMQRCodeScanManager;

@protocol ZJMQRCodeScanManagerDelegate <NSObject>
...
@interface ZJMQRCodeScanManager : NSObject
/** 快速创建单利方法 */
+ (instancetype)sharedManager;
/**  SGQRCodeScanManagerDelegate */
@property (nonatomic, weak) id<ZJMQRCodeScanManagerDelegate> delegate;
