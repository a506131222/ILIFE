...
@interface ZJMQRCodeAlbumManager () <UINavigationControllerDelegate, UIImagePickerControllerDelegate>
@property (nonatomic, strong) UIViewController *currentVC;
@property (nonatomic, strong) NSString *detectorString;
@end

@implementation ZJMQRCodeAlbumManager

+ (instancetype)sharedManager {
    static ZJMQRCodeAlbumManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[ZJMQRCodeAlbumManager alloc] init];
    });
    return manager;
}
